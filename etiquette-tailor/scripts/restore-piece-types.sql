-- Restore Default Piece Types
-- Run this with: sqlite3 app.db < restore-piece-types.sql

-- Delete existing piece types
DELETE FROM piece_types;

-- Insert default piece types
